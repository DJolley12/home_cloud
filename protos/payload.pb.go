...
var file_protos_payload_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x31, 0x0a, 0x09, 0x44, 0x61, 0x74, 0x61, 0x43, 0x68,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0x67, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6c,
	0x6f, 0x61, 0x64, 0x12, 0x2d, 0x0a, 0x0e, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x50, 0x61,
...
var file_protos_payload_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_protos_payload_proto_depIdxs = []int32{
	0, // 0: Payload.ReceivePayload:input_type -> DataChunk
	2, // 1: Payload.SendPayload:input_type -> DownloadRequest
	1, // 2: Payload.ReceivePayload:output_type -> UploadResult
	0, // 3: Payload.SendPayload:output_type -> DataChunk
